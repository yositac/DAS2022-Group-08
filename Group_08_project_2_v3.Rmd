...
Colombia has the most good coffee, while Mexico has the most bad coffee, Ethiopia only has good coffee.
...
In 2012, 2016 and 2017 there was a larger proportion of bad coffee, and in all other years there was a larger proportion of good coffee.
...
```{r model comparison, warning=FALSE, message=FALSE,fig.align = "center",  fig.pos = 'H', out.width='40%'}
#compare 5 models
...
\newpage 
## log Odds: 
```{r odds plot, warning=FALSE, message=FALSE, fig.cap = "\\label{fig:logodds} Log Odds r each quality class in every continents.",out.width = '68%', fig.align = "center",  fig.pos = 'H'}
#Odds Plot
